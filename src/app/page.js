    ...
    <main className="flex-1 bg-carbon flex flex-col items-center justify-between px-8 py-16 relative overflow-hidden">
      ...
      <div className="z-10 w-full flex flex-col items-center gap-3">
        ...
        <div className="flex gap-3 w-full">
          <button className="flex-1 flex items-center justify-center gap-2 bg-[#252523] border border-[#333330] rounded-full py-3.5 text-[12px] font-medium text-cream">
        ...
        <div className="flex items-center gap-3 w-full">
          <div className="flex-1 h-px bg-[#2E2E2C]" />
          <span className="text-[10px] text-[#3A3A38] font-light">o</span>
          <div className="flex-1 h-px bg-[#2E2E2C]" />
        </div>
        ...
        <Link href="/registro" className="w-full text-center bg-transparent text-[#5A5855] border border-[#2E2E2C] rounded-full py-4 text-sm font-light transition-all duration-200">
          Crear cuenta nueva
        </Link>
        <p className="text-[10px] text-[#2E2E2C] text-center leading-relaxed font-light">
          Al continuar aceptas los{' '}
          <span className="text-[#4A4845]">términos de uso</span>
        </p>
      </div>
    </main>
  )
