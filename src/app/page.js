  ...
  return (
    <main className="flex-1 bg-carbon flex flex-col items-center justify-between px-8 py-16 relative overflow-hidden">
      ...
      <div className="z-10 w-full flex flex-col items-center gap-3">
        <Link href="/mapa" className="btn-primary text-center block">Explorar el mapa</Link>
        <Link href="/agregar" className="w-full text-center bg-transparent text-[#5A5855] border border-[#2E2E2C] rounded-full py-4 text-sm font-light hover:border-[#4A4845] transition-all duration-200">
          Registrar mi negocio
        </Link>
        <p className="text-[10px] text-[#2E2E2C] text-center leading-relaxed font-light">
          Al continuar aceptas los <a href="#" className="text-[#4A4845]">términos de uso</a> y la <a href="#" className="text-[#4A4845]">política de privacidad</a>
        </p>
      </div>
    </main>
  )
